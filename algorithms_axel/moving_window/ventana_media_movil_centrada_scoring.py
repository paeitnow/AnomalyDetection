...
values = data['value']
labels = data['label'].values  # Añadir las etiquetas (1 para anomalías, 0 para normal)

# Parámetros de la ventana cuadrada
time_window_size = 3 # Tamaño de la ventana en el eje X (tiempo), debe ser un número par
value_range = 0.098  # Rango de valores permitidos en el eje Y
...
# Calcular precisión y recall (Scoring)
